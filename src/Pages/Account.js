        ...
        if(!isLoading){
            if(name === '' || email === '' || password === '') {
                ...
                navigation.navigate('Login');
                  ...
                  Alert.alert('Falha novo usuário', 'Ocorreu um erro na criação do usuário, tente novamente');
                }
            }
        }
    }
    ...
    return (
        <KeyboardAvoidingView 
            ...
            <View style={styles.form}>
                ...
                Preencha os campos para criar um usuário, que será desbloqueado pelo administrador</Text>
                ...
                <View>
                    <Icon name='eye-slash' size={24} style={styles.IconInput} />
                    <TextInput
                        style={styles.input}
