    ...
    if (!isLoading) {
      try {
        if (email === '') {
          ...
          Alert.alert(
            'Recuperação Senha',
            'E-mail enviado com sucesso, verifique sua caixa de mensagem.',
          );
    ...
    <KeyboardAvoidingView
      ...
      <View style={styles.form}>
        ...
        <Text style={styles.label}>
          Você esqueceu sua senha, informe seu e-mail que nós enviaremos uma
          mensagem com um link para você criar uma nova senha!
        </Text>
